...
# 查询票价类型
def query_ticket_type(PlanCode):
    """
    :param PlanCode: 放映计划编码
    :return:
    """
    msg = """<?xml version="1.0" encoding="UTF-8"?>
<OnlineTicketingServiceQuery Version="1.0" Datetime="2013-01-01T00:00:00" Username="{Username}" Password="e10adc3949ba59abbe56e057f20f883e">
<QueryTicketType CinemaCode="{CinemaCode}" Id="ID_QueryTicketType">
		<PlanCode>{PlanCode}|-1</PlanCode>
</QueryTicketType>
...
......
    ...
    # 替换影院编码
    msg = msg.format(CinemaCode=cinema_code, Username=net_user,PlanCode=PlanCode)
    return msg

# 同步渠道列表接口
def sync_channel_list():
    """
    :param PlanCode: 放映计划编码
    :return:
    """
    msg = """<?xml version="1.0" encoding="UTF-8"?>
<OnlineTicketingServiceQuery Version="1.0" Datetime="2013-01-01T00:00:00" Username="{Username}" Password="e10adc3949ba59abbe56e057f20f883e">
<SyncChannelList CinemaCode="{CinemaCode}" Id="ID_SyncChannelList">
			<Timestamp>请求时间戳</Timestamp>
<ChannelList>
...
# 查询订单信息
def query_order_info(OrderCode):
    """
    :param OrderCode: 订单编码
    :return:
    """
    msg = """<?xml version="1.0" encoding="UTF-8"?>
<OnlineTicketingServiceQuery Version="1.0" Datetime="2013-01-01T00:00:00" Username="
{Username}" Password="e10adc3949ba59abbe56e057f20f883e">
<DQueryOrder CinemaCode="{CinemaCode}" Id="ID_DQueryOrder">
...
......
    ...
    # 替换影院编码
    msg = msg.format(CinemaCode=cinema_code, Username=net_user,OrderCode=OrderCode)
    return msg